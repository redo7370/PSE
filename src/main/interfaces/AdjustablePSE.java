...
/**
 * Interface that combines PSETemplate and Adjustable interfaces.
 * This interface is used for elements that can be adjusted in the PSE application.
 * It extends the functionality of PSETemplate with adjustable features.
 */
public interface AdjustablePSE extends PSETemplate, Adjustable {
}
